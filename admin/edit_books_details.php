...
<td><a href='edit_books.php?book_id=$fetch_details[0]'><button>Edit Record</button></a>
<button onclick='enter_book($fetch_details[0],$fetch_details[4])'>Delete Copies</button></a></td>
";
